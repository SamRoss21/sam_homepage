    ...
    return Column(children: [
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  fit: BoxFit.cover,
                  image: AssetImage('Sam_Photo.jpg'),
                ),
            ...
            Container(
              ...
              child: Text.rich(TextSpan(
                  style: const TextStyle(fontSize: 12, height: 3, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 51, 10, 111)),
                  children: [
                    ...
                    TextSpan(text: "  Email\n", recognizer: TapGestureRecognizer()..onTap = () => launchUrl(Uri.parse('mailto:samhross@cs.washington.edu'))),
                    const WidgetSpan(alignment: PlaceholderAlignment.middle, child: Icon(FontAwesomeIcons.linkedin, size: 15,)),
                    TextSpan(text: "  LinkedIn\n", recognizer: TapGestureRecognizer()..onTap = () => launchUrl(Uri.parse('https://www.linkedin.com/in/sam-ross-09936a190/'))),
                    const WidgetSpan(alignment: PlaceholderAlignment.middle, child: Icon(FontAwesomeIcons.googleScholar, size: 15,)),
                    TextSpan(text: "  Google Scholar\n", recognizer: TapGestureRecognizer()..onTap = () => launchUrl(Uri.parse('https://scholar.google.com/citations?user=aPo_CMMAAAAJ&hl=en'))),
